...
namespace Gerenciamento_de_Van.Controllers
{
    public class VansController : Controller
    {
        private static readonly List<Van> _vans = new List<Van>
        {
            ...
            new Van { Id = 3, Plate = "GHI-9012", Driver = "Carlos Pereira", Capacity = 15, Route = "Centro - Distrito Industrial", Schedule = "08:00 / 19:00", Status = "Operacional", Description = "Van de maior capacidade para trajetos longos." }
        };
